...
'6. gill-attachment': {'6_a': 'blue', '6_d': 'orange', '6_f': 'green', '6_n': 'red'},
        ...
        '20. spore-print-color': {'20_k': 'black', '20_n': 'brown', '20_b': 'lightgray', '20_h': 'chocolate', '20_r': 'green',
                                  '20_o': 'orange', '20_u': 'purple', '20_w': 'blue', '20_y': 'yellow'},
    ...
    def plot_learning_curve(estimator, title, X, y, cv=None, n_jobs=None):
        ...
        for i in range(len(train_sizes)):
            plt.text(train_sizes[i], train_scores_mean[i], f'{train_scores_mean[i]:.2f}', color="r", ha='center', va='bottom')
            plt.text(train_sizes[i], test_scores_mean[i], f'{test_scores_mean[i]:.2f}', color="g", ha='center', va='bottom')
